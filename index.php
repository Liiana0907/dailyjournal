      ...
      <div class="container">
        ...
        <div id="carouselExample" class="carousel slide">
          <div class="carousel-inner">
            ...
            <div class="carousel-item">
              <img src="assets/gambar4.jpeg" class="d-block w-100" alt="..." />
            </div>
          </div>
          <button
    ...
    <footer class="text-center p-2">
      <div class="text-center mt-4">
        <a href="https://www.instagram.com/udinusofficial"
          ><i class="bi bi-instagram h2 p-2 icon-dark-mode"></i
        ></a>
        <a href="https://twitter.com/udinusofficial"
          ><i class="bi bi-twitter-x h2 p-2 icon-dark-mode"></i
        ></a>
        <a href="https://wa.me/+6285726170059"
          ><i class="bi bi-whatsapp h2 p-2 icon-dark-mode"></i
        ></a>
      </div>
